...
<!-- broken image: php://input方法 (ex_7.png) -->
...
<!-- broken image: preg_replace方法 (ex_8.png) -->
...
<!-- broken image: ob_start (ex_9.png) -->
...
<!-- broken image: 免杀 (ex_16.png) -->

再试试其他免杀工具。

WebShellKiller：

<!-- broken image: WebShellKiller (ex_17.png) -->

安全狗：

<!-- broken image: 安全狗 (ex_18.png) -->

微步云沙箱：

<!-- broken image: 微步云沙箱 (ex_19.png) -->

再试试可不可以连接没有问题，完美！！

<!-- broken image: 菜刀 (ex_20.png) -->
